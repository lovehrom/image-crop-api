...
# -*- coding: utf-8 -*-
"""
Image Crop API - Full Test Suite
...
# ─── CONFIG ───────────────────────────────────────────────────────────────────
API_URL = "https://image-crop-api-ten.vercel.app/crop"  # Текущий деплой
...
def test_crop(test_name, params, image_buf=None):
    ...
    try:
        resp = requests.post(API_URL, headers={}, files=files, data=params, timeout=30)
